...
function convert(buffer, name) {
	...
	flight_groups.forEach(function(item) {
		// main unit node and attributes
		var unitNode = xmlDoc.createElement("unit");
		unitNode.setAttribute("type", item.flight_group_type);
		unitNode.setAttribute("name", item.designation);
		unitNode.setAttribute("skill", item.craft_ai);
		unitNode.setAttribute("iff", item.craft_iff);
		unitNode.setAttribute("status", item.craft_status);
		unitNode.setAttribute("color", item.craft_color);
		unitNode.setAttribute("count", item.number_in_wave);
		unitNode.setAttribute("waves", item.number_of_waves);
		unitNode.setAttribute("formation", item.formation);
		unitNode.setAttribute("cargo", item.cargo);
		unitNode.setAttribute("specialcargo", item.special_cargo);
		unitNode.setAttribute("specialcargo", item.special_cargo);
		if (item.player_pos) {
			unitNode.setAttribute("player", item.player_pos);
		}
		groupNode.appendChild(unitNode);
		...
		unitNode.appendChild(arrivalNode);
		...
		unitNode.appendChild(departureNode);
		
		// waypoints
		var waypointsNode = xmlDoc.createElement("waypoints");
		unitNode.appendChild(waypointsNode);
		...
		unitNode.appendChild(ordersNode);
	...
	//var pd = require('./../pretty-data/pretty-data').pd;
	//document.getElementById('result').value = pd.xml(xmlString);
	
	downloadXML(xmlString, name);
}

//document.getElementById('doit').addEventListener('click', convert);
